...
def main():
    ...
    with torch.no_grad():
        for i in tqdm(range(100)):
            ...
            persons_pred, mutants = pred_to_person(joint_det, edge_index, pred, config.MODEL.GC.CC_METHOD)
            persons_pred_label, _= pred_to_person(joint_det, edge_index, edge_labels, config.MODEL.GC.CC_METHOD)
