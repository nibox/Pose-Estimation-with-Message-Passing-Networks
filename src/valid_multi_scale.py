...
def main():
    ...
    eval_writer = EvalWriter(config, fname="eval_10_version_2_without_flipping")
...
def perd_to_ann(scoremaps, joint_det, joint_scores, edge_index, pred, img_info, img_id, cc_method, scaling_type, min_scale,
